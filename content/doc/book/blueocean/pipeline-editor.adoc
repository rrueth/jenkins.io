...
Stages can be added to the Pipeline by clicking the "{plus}" button to the right of an existing stage.
Parallel stages can be added by clicking the "{plus}" button below an existing Stage.
