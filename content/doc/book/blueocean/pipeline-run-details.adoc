...
This tab will only contain information if a test result publishing step exists,
...
In the case of failures, the tab will display logs detailing the failures as shown below.
